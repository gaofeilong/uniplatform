...
(function () {
	...
	function Cb(a, b, c, d) {
		...
		if (r(b)) {
			...
			for (var d = i.getTime(), l = i[Xa](), m = i[Ma](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c; )
				e.push(d), j === D[va] ? d = Za(h + b * k, 0) : j === D[La] ? d = Za(h, l + b * k) : !g && (j === D[ma] || j === D[Wa]) ? d = Za(h, l, m + b * k * (j === D[ma] ? 1 : 7)) : (d += j * k, j <= D[Ka] && d % D[ma] === i && (f[d] = ma)), b++;
			e.push(d)
		}
		e.info = x(a, {
				higherRanks : f,
				...
				for (c in a)
					if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
						...
						[d];
							...
							e = g.getElementsByTagName("title")[0], e || (e = C.createElementNS(oa, "title"), g.appendChild(e)), e.textContent = d;
						...
						if (l && /^(width|height|visibility|x|y|d|transform)$/.test(c))
							for (e = l.length; e--; )
								w(l[e], c, c === "height" ? s(d - (l[e].cutHeight || 0), 0) : d);
						if ((c === "width" || c === "height") &&
							h === "rect" && d < 0)
							d = 0;
						this[c] = d;
		...
		getBBox : function () {
			...
			if (!a) {
				...
				if (b.isSVG) {
					b = a.width;
					c = a.height;
					if (Ea && e && e.fontSize === "11px" && c === 22.700000762939453)
						a.height = c = 14;
					if (d)
						a.width = M(c * Z(f)) + M(b * W(f)), a.height = M(c * W(f)) + M(b * Z(f))
				}
				this.bBox = a
			}
			return a
		...
		shadow : function (a, b, c) {
			...
			if (a) {
				...
				for (e = 1; e <= i; e++) {
					...
					if (c)
						w(f, "height", s(w(f, "height") - h, 0)), f.cutHeight = h;
	...
	sa.prototype = {
		...
		init : function (a, b, c, d) {
			...
			this.forExport = d;
			this.gradients = {};
			/**this.setSize(b, c, !1); pww modify 2013-09-10*/
			this.setSize(b+110, c, !1);
			var g;
		...
		buildText : function (a) {
			for (var b = a.element, c = n(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g,
						"<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = w(b, "x"), h = a.styles, i = h && h.width && z(h.width), j = h && h.lineHeight, k, h = d.length, l = []; h--; )
				b.removeChild(d[h]);
			...
			o(c, function (c, d) {
				...
				o(h, function (c) {
					if (c !== "" || h.length === 1) {
						...
						y++;
						if (i)
							for (var c = c.replace(/([^\^])-/g, "$1- ").split(" "), E = []; c.length || E.length; )
								delete a.bBox, r = a.getBBox().width, m = r > i, !m || c.length === 1 ? (c = E, E = [], c.length && (n = C.createElementNS(oa, "tspan"), w(n, {
											dy : j || 16,
											x : g
		...
		label : function (a, b, c, d, e, f, g, h, i) {
			function j() {
				...
				if (z) {
					if (!n)
						a = h ? -zb : 0, p.box = n = d ? q.symbol(d, -ra * v, a, p.width, p.height) : q.rect(-ra * v, a, p.width, p.height, 0, w[wb]), n.add(p);
					n.attr(B({
							width : p.width,
							height : p.height
						}, w));
	...
	if (!ca && !V) {
		ha = {
			init : function (a, b) {
				...
				c.push(' style="', d.join(""), '"/>');
				if (b)
					c = b === ga || b === "span" || b === "img" ? c.join("") : a.prepVML(c), this.element = T(c);
				this.renderer = a;
				this.attrSetters = {}
					...
					for (c in a)
						if (d = a[c], m = !1, e = q[c] && q[c].call(this, d, c), e !== !1 && d !== null) {
							...
							if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))
								...
								e = d.length;
								for (m = []; e--; )
									m[e] = Da(d[e]) ? u(d[e] * 10) - 5 : d[e] === "Z" ? "x" : d[e];
								d = m.join(" ") || "x";
								f.path = d;
								if (l)
									for (e = l.length; e--; )
								...
								d = s(0, d), this[c] = d, this.updateClipping ? (this[c] = d, this.updateClipping()) :
								g[c] = d, m = !0;
							else if (c === "x" || c === "y")
								this[c] = d, g[{
										x : "left",
								...
								f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, Da(d) && (d += "px");
							else if (c === "dashstyle")
								...
								if (h === "SPAN")
									...
									if (h !== "IMG")
										f.filled = d !== Q ? !0 : !1, d = i.color(d,
												f, c, this), c = "fillcolor"
								}
							else if (h === "shape" && c === "rotation")
								this[c] = d, f.style.left = -u(Z(d * ab) + 1) + "px", f.style.top = u(W(d * ab)) + "px";
		...
		var fa = {
			...
			init : function (a, b, c) {
				...
				this.setSize(b, c, !1);
				if (!C.namespaces.hcv)
					C.namespaces.add("hcv", "urn:schemas-microsoft-com:vml"), C.createStyleSheet().cssText = "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } "
			},
			isHidden : function () {
			...
			color : function (a, b, c, d) {
				...
				if (i) {
					...
					if (c === "fill")
						if (i === "gradient")
							c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, q = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, r = 'angle="' + (90 - K.atan((m - a) / (q - c)) * 180 / Aa) + '"', u();
						else {
							var j = m.r,
							E = j * 2,
							S = j * 2,
					...
					f = qa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], T(this.prepVML(h), null, null, b), j = f.get("rgb");
				else {
	...
	Qa.prototype = {
		...
		render : function (a, b) {
			...
			if (l && t)
				r === "inside" && (t = -t), c.opposite && (t = -t), g = this.getMarkPath(S, E, t, l, f, e), m ? m.animate({
					d : g
	...
	nb.prototype = {
		render : function () {
			...
			if (f && r(f.text) && p && p.length && b.width > 0 && b.height > 0) {
				...
				if (!g)
					a.label = g = v.text(f.text, 0, 0).attr({
	...
	ob.prototype = {
		...
		init : function (a, b) {
			...
			for (g in d)
				J(this, g, d[g]);
			if (this.isLog)
				this.val2lin = ka, this.lin2val = aa
		},
		setOptions : function (a) {
			this.options = B(this.defaultOptions, this.isXAxis ? {}

					 : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], B(N[this.isXAxis ? "xAxis" : "yAxis"], a))
		},
		defaultLabelFormatter : function () {
			...
			if (a.categories)
				...
				for (; e-- && f === A; )
					a = Math.pow(1E3, e + 1), g >= a && d[e] !== null && (f = Ja(b / a, -1) + d[e]);
				...
				if (g.visible || !b.options.chart.ignoreHiddenSeries) {
					...
					if (a.isXAxis) {
						if (h = g.xData, h.length)
							a.dataMin = O(n(a.dataMin, h[0]), Fa(h)), a.dataMax = s(n(a.dataMax, h[0]), wa(h))
					} else {
						var z,
						E,
						S,
						...
						if (i)
							m = h.stack, l = g.type + n(m, ""), q = "-" + l, g.stackKey = l, j = d[l] || [], d[l] = j, k = e[q] || [], e[q] = k;
						if (a.usePercentage)
						...
						if (!a.usePercentage && v.length)
							a.dataMin = O(n(a.dataMin, v[0]), Fa(v)), a.dataMax = s(n(a.dataMax, v[0]), wa(v));
						if (r(o))
							if (a.dataMin >= o)
								a.dataMin = o, a.ignoreMinPadding =
									!0;
							else if (a.dataMax < o)
								a.dataMax = o, a.ignoreMaxPadding = !0
					}
				}
			})
		},
		...
		getLogTickPositions : function (a, b, c, d) {
			...
			if (a >= 0.5)
				...
				for (var f = U(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
					i = e.length;
					for (h = 0; h < i && !l; h++)
						j = ka(aa(f) * e[h]), j > b && g.push(k), k > c && (l = !0), k = j
				}
			else if (b = aa(b), c = aa(c), a = e[d ? "minorTickInterval" :
						"tickInterval"], a = n(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = hb(a, null, K.pow(10, U(K.log(a) / K.LN10))), g = Ta(this.getLinearTickPositions(a, b, c), ka), !d)
		...
		adjustForMinRange : function () {
			...
			if (this.isXAxis && this.minRange === A && !this.isLog)
				r(a.min) || r(a.max) ? this.minRange = null : (o(this.series, function (a) {
							i = a.xData;
		...
		setAxisTranslation : function () {
			...
			g = this.transA;
			if (this.isXAxis)
				f ? (d = f.minPointOffset, e = f.pointRangePadding) : o(this.series, function (a) {
					var f = a.pointRange,
		...
		setTickPositions : function (a) {
			...
			if (e)
				!a && O(b.min, n(b.dataMin, b.min)) <= 0 && Oa(10, 1), b.min = da(ka(b.min)), b.max = da(ka(b.max));
			...
			if (!l && b.tickInterval < m)
				b.tickInterval = m;
			if (!f && !e && (a = K.pow(10, U(K.log(b.tickInterval) / K.LN10)), !l))
			...
			if (!i)
				i = f ? (b.getNonLinearTimeTicks || Cb)(Ab(b.tickInterval,
			...
			if (!h)
				e = i[0], f = i[i.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && i.shift(), d.endOnTick ? b.max = f : b.max + h < f && i.pop(), i.length === 1 && (b.min -= 1.0E-9, b.max += 1.0E-9)
		},
		setMaxTicks : function () {
			...
			if (!this.isLinked &&
				!this.isDatetimeAxis && c.length > b[d] && this.options.alignTicks !== !1)
				b[d] = c.length;
			a.maxTicks = b
		},
			...
			if (b || a.isLinked)
				o(e, function (b) {
					...
					if (h === 0 || h === 2 || {
						...
						[h] === q.align)
						p = s(f[a].getLabelSize(), p)
				}), a.staggerLines && (p += (a.staggerLines - 1) * 16);
			else
				for (H in f)
					f[H].destroy(), delete f[H];
			if (m && m.text) {
				if (!a.axisTitle)
		...
		render : function () {
			...
			n = d.lineWidth,
			t,
			H = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin),
			u = a.showAxis,
			v,
			s;
			if (a.hasData || f)
				if (a.minorTickInterval && !a.categories && o(a.getMinorTickPositions(), function (b) {
						...
						if (!f ||
							b >= a.min && b <= a.max)
							j[b] || (j[b] = new Qa(a, b)) , H && j[b].isNew && j[b].render(c, !0), j[b].isActive = !0, j[b].render(c)
						}), q && o(g, function (b, c) {
							if (c % 2 === 0 && b < a.max)
								l[b] || (l[b] = new nb(a)), v = b + p, s = g[c + 1] !== A ? g[c + 1] + p : a.max, l[b].options = {
									from : e ? aa(v) : v,
									to : e ? aa(s) : s,
									color : q
								},
			...
			if (n)
				t = a.getLinePath(n), a.axisLine ? a.axisLine.animate({
					d : t
			...
			if (q) {
				...
				for (e = q.length; e--; )
					if (i = a.series[e ? "yAxis" : "xAxis"], q[e] && i)
						if (i = i.getPlotLinePath(e ? n(a.stackY, a.y) : a.x, 1), this.crosshairs[e])
	...
	qb.prototype = {
		...
		onmousemove : function (a) {
			...
			if (d && this.options.tooltip.shared && (!g ||
				...
				h = c.length;
				for (i = 0; i < h; i++)
					if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints && c[i].tooltipPoints.length)
						b = c[i].tooltipPoints[k], b._dist = M(k - b[c[i].xAxis.tooltipPosName || "plotX"]), j = O(j, b._dist), e.push(b);
				for (h = e.length; h--; )
		...
		setDOMEvents : function () {
			...
			var h = function (a) {
				if (!a || !(a.touches && a.touches.length > 1)) {
					...
					if (d.indexOf("touch") === -1)
						a.returnValue = !1;
					d === "touchstart" && (w(a.target, "isTracker") ? c.runTrackerClick || a.preventDefault() : !c.runChartClick && !m && a.preventDefault());
					if (m)
						h < c.plotLeft ? h = c.plotLeft : h > c.plotLeft + c.plotWidth && (h = c.plotLeft + c.plotWidth), l < c.plotTop ? l = c.plotTop : l > c.plotTop + c.plotHeight && (l = c.plotTop + c.plotHeight);
					if (c.mouseIsDown && d !== "touchstart" && (e = Math.sqrt(Math.pow(b.mouseDownX - h, 2) + Math.pow(b.mouseDownY - l, 2)), e > 10)) {
						...
						if (c.hasCartesianSeries && (b.zoomX || b.zoomY) && d && !b.selectionMarker)
			...
			d.onclick = function (a) {
				...
				a.cancelBubble = !0;
				if (!c.cancelClick)
					d && (w(a.target, "isTracker") || w(a.target.parentNode, "isTracker")) ? (e = d.plotX, f = d.plotY, x(d, {
	...
	rb.prototype = {
		...
		renderItem : function (a) {
			...
			if (!t && (a.legendGroup = d.g("legend-item").attr({
					...
					}), b.colorizeItem(a, a.visible), u && v))
				a.checkbox = T("input", {
						type : "checkbox",
						checked : a.selected,
			...
			if (f && b.itemX - o + e > (m || c.chartWidth - 2 * k - o))
				b.itemX = o, b.itemY += n + b.lastLineHeight + q, b.lastLineHeight = 0;
		...
		render : function () {
			...
			if (l || m) {
				...
				if (i) {
					...
					a.box = i = c.rect(0, 0, g, h, j.borderRadius,
							l || 0).attr({
		...
		scroll : function (a, b) {
			...
			d > c && (d = c);
			if (d > 0)
				b !== A && xa(b, this.chart), this.nav.attr({
					translateX : i,
					translateY : e + 7,
					visibility : "visible"
				}), this.up.attr({
	...
	sb.prototype = {
		...
		getContainer : function () {
			...
			this.container = a = T(ga, {
					...
					id : e
						...
						position : "relative",
						/***overflow : "hidden", pww modify 2013-09-10*/
                        overflow : "visible",
						width : c + "px",
						height : d + "px",
						textAlign : "left",
		...
		getMargins : function () {
			...
			if ((this.title || this.subtitle) &&
				!r(this.optionsMarginTop))
				if (l = s(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !l.floating && !l.verticalAlign && l.y || 0))
					this.plotTop = s(this.plotTop, l + n(k.margin, 15) + b);
			if (f.display && !m.floating)
				if (t === "right") {
					if (!r(i))
						this.marginRight = s(this.marginRight, f.legendWidth - p + q + c)
				} else if (t === "left") {
					if (!r(h))
						this.plotLeft = s(this.plotLeft, f.legendWidth + p + q + a)
				} else if (u === "top") {
					if (!r(g))
						this.plotTop = s(this.plotTop, f.legendHeight + y + q + b)
				} else if (u === "bottom" && !r(j))
					this.marginBottom = s(this.marginBottom,
		...
		initReflow : function () {
			function a(a) {
				...
				if (!b.hasUserSize && g && h && (a === L || a === C)) {
					if (g !==
						b.containerWidth || h !== b.containerHeight)
		...
		setSize : function (a, b, c) {
			...
			if (r(a))
				d.chartWidth = e = s(0, u(a)), d.hasUserSize = !!e;
			if (r(b))
				d.chartHeight = f = s(0, u(b));
			I(d.container, {
				width : e + "px",
				height : f + "px"
			});
		...
		drawChartBox : function () {
			...
			if (k)
				f ? f.animate(u) : this.plotBackground = b.rect(p, o, t, r, 0).attr({
						fill : k
					}).add().shadow(a.plotShadow);
			if (l)
				h ? h.animate(u) : this.plotBGImage = b.image(l, p, o, t, r).add();
			v ? v.animate({
				width : s.width,
				height : s.height
			}) : this.clipRect = b.clipRect(s);
			if (m)
				g ? g.animate(g.crisp(null, p, o, t, r)) : this.plotBorder = b.rect(p, o, t, r, 0, m).attr({
	...
	Ua.prototype = {
		...
		destroyElements : function () {
			for (var a =
					"graphic,tracker,dataLabel,dataLabelUpper,group,connector,shadowGroup".split(","), b, c = 6; c--; )
	...
	P.prototype = {
		...
		generatePoints : function () {
			...
			for (m = 0; m < g; m++)
				i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(la(e[m]))) : (b[i] ? k = b[i] : a[i] !== A && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
			if (b && (g !== (c = b.length) || j))
				for (m = 0; m < c; m++)
					if (m === h && !j && (m += g), b[m])
						b[m].destroyElements(),
		...
		translate : function () {
			...
			for (l = 0; l < h; l++) {
				...
				if (c && this.visible &&
					t && t[q])
					o = t[q], q = o.total, o.cum = o = o.cum - p, p = o + p, j && (o = n(b.threshold, f.min)), f.isLog && o <= 0 && (o = null), c === "percent" && (o = q ? o * 100 / q : 0, p = q ? p * 100 / q : 0), k.percentage = q ? k.y * 100 / q : 0, k.total = k.stackTotal = q, k.stackY = p;
		...
		setTooltipPoints : function (a) {
			...
			if (this.options.enableMouseTracking !== !1) {
				...
				for (h = 0; h < a; h++) {
					g = b[h];
					c = b[h - 1] ? d + 1 : 0;
					for (d = b[h + 1] ? s(0, U((g[f] + (b[h + 1] ? b[h + 1][f] : e)) / 2)) : e; c >= 0 && c <= d; )
						i[c++] = g
				}
		...
		animate : function (a) {
			...
			if (a)
				a = c[h], e = c[h + "m"], a || (c[h] = a = d.clipRect(x(f, {
								width : 0
		...
		drawDataLabels : function () {
			...
			if (b.enabled || a._hasPointLabels)
				a.dlProcessOptions && a.dlProcessOptions(b), g = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible" : "hidden", b.zIndex || 6), e = b, o(c, function (c) {
					var i,
					j = c.dataLabel,
					k,
					l = !0;
		...
		setState : function (a) {
			...
			a = a || "";
			if (this.state !== a)
				this.state = a, d[a] && d[a].enabled === !1 || (a && (b = d[a].lineWidth || b + 1), c && !c.dashstyle &&
					c.attr({
						"stroke-width" : b
					}, a ? 0 : 500))
		},
		...
		drawTracker : function () {
			...
			if (i)
				i.attr({
					...
					}).on("mouseover", n).on("mouseout", o).css(j).add(l), Ba)
				i.on("touchstart", n)
		}
	};
	G = ba(P);
			...
			getSegmentPath : function (a) {
				...
				if (e.stacking && !this.closedStacks)
					for (d = a.length - 1; d >= 0; d--)
						d < a.length - 1 && e.step && c.push(a[d + 1].plotX,
	...
	fa = ba(P, {
			...
			translate : function () {
				...
				c.grouping === !1 ? f = 1 : o(b.series, function (b) {
						...
						if (b.type === a.type && b.visible && a.options.group === c.group)
							c.stacking ? (k = b.stackKey, j[k] === A && (j[k] = f++), l = j[k]) : c.grouping !== !1 && (l = f++), b.columnIndex = l
					});
				var m = a.points,
			...
			drawPoints : function () {
				...
				o(a.points, function (e) {
					var f = e.plotY,
					g = e.graphic;
					if (f !== A && !isNaN(f) && e.y !== null)
						d = e.shapeArgs, g ? (fb(g), g.animate(B(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow,
			...
			drawTracker : function () {
				for (var a = this, b = a.chart, c = b.renderer, d, e, f = +new Date, g = a.options, h = (d = g.cursor) && {
					...
					if (b.hoverSeries !== a && w(j, "isTracker") !== f)
						a.onMouseOver();
						...
						if (e)
							e.attr(d);
									...
									fill : vb,
									visibility : a.visible ? "visible" : "hidden"
								}).on("mouseover", o).on("mouseout", r).css(h).add(m.group || i), Ba)
							e.on("touchstart", o);
						e.element._i = n
					}
			},
	...
	pa = {
		...
		translate : function () {
			...
			i,
			j,
			k = this.startAngleRad = Aa / 180 * ((c.startAngle || 0) % 360 - 90),
			l = this.points,
			m = 2 * Aa,
				...
				for (a = p[0][0] && p[0][0].dataLabel && (p[0][0].dataLabel.getBBox().height || 21); u--; ) {
					...
					if (j > 0) {
						...
						for (v = 0; v < C; v++) {
							...
							b = 9999;
							for (t = 0; t < s; t++)
								g = M(w[t] - h[1]), g < b && (b = g, D = t);
							if (D < v && w[v] !== null)
								D = v;
							else
								for (s < C - v + D && w[v] !== null && (D = s - C + v); w[D] === null; )
									D++;
							A.push({
								i : D,
								y : w[D]
					...
					for (v = 0; v < C; v++) {
						...
						r = h[1];
						if (j > 0) {
							if (t = A.pop(), D = t.i, t = t.y, r > t && w[D + 1] !== null || r < t && w[D - 1] !== null)
								t = r
						} else
							t = r;
						...
						g.moved = !0;
						if (q && f)
							g = b.connector, h = i ? ["M", r + (h[6] === "left" ? 5 : -5), t, "C", r, t, 2 * h[2] - h[4], 2 * h[3] - h[5], h[2], h[3], "L", h[4], h[5]] : ["M", r + (h[6] === "left" ? 5 : -5), t, "L", h[2], h[3], "L", h[4], h[5]], g ? (g.animate({
									d : h
